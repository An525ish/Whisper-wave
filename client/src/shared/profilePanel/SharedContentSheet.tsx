            ...
            filteredLinks.length === 0 ? (
              ...
              <div className="flex flex-col gap-2">
                {filteredLinks.map((link) => (
                  ...
                  >
                    <span className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-green-dark/70 to-primary ring-1 ring-green/25">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-0.5 line-clamp-1 text-[11px] leading-snug text-body-300">
                        {link.url}
                      </p>
                    </div>
