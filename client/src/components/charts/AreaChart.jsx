...
const AreaChart = ({ chartData }) => {
    ...
    const data2 = generateRandomData(0, 100, 50);
    ...
    const chartDataConfig = {
        ...
        datasets: [
            ...
            //         const bgColor = ['rgba(41, 187, 117, 0.23)', 'rgba(41, 187, 117, 0)'];
    ...
    return (
        <>
            <div className="w-full">
                <canvas id="myAreaChart" width={350} height={250}></canvas>
            </div>
        </>
    );
};
