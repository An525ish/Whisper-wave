 ...
 * features. The shared visual shorthand for "anonymous" across the landing
 * hero (crowd avatars, side whispers). `color` themes it violet (stranger) or
 * teal (you). Decorative → aria-hidden; size via `className`.
 */
