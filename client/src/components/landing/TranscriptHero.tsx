...
import SideWhispers from '@/components/landing/ui/SideWhispers';
...
const TranscriptHero = () => (
  ...
  >
    ...
    <SignalWave className="absolute inset-x-0 bottom-[4%] z-0 h-[150px] opacity-55" />
    ...
    <div className="relative z-[3] flex flex-col items-center gap-6 text-center">
      <h1 className="font-lw-display text-[clamp(2.4rem,7.5vw,5rem)] font-normal leading-[0.92] tracking-[-0.03em] text-lw-text">
        Talk to no-one. <span className="lw-iri italic">Everyone.</span>
      </h1>

      <Link
        to="/auth"
        className={cn(
          'lw-sheen group inline-flex items-center gap-2.5 rounded-full px-8 py-4 text-[1.05rem] font-semibold text-white-pure no-underline',
      ...
      <p className="font-lw-mono text-[0.66rem] tracking-[0.16em] text-lw-text-faint opacity-70">
