import { useActiveMessageDatesQuery, useChatDetailsQuery, useJumpToDateMutation, useSearchMessagesQuery } from '@/features/chat/hooks'
...
type ChatMember = { _id?: string; name?: string; avatar?: string }
type ChatDetailsResponse = {
  data?: { groupChat?: boolean; name?: string; avatar?: string | string[]; members?: ChatMember[] }
}
