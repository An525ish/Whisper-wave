import { fileFormat, getMediaKindFromFile, type FileFormatKind } from '@/shared/utils/fileFormat';
import { extractLinksFromText, isLinkOnlyMessage } from '@/shared/utils/linkParser';
import dayjs from 'dayjs';
import { useAuthStore } from '@/features/auth/store';
import ImageViewer, {
  type MediaFile,
} from '@/shared/components/image-viewer/ImageViewer';
import { useGetMediaQuery } from '@/features/chat/hooks';
